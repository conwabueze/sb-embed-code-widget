...
import { EmbedCodeWidgetProps, EmbedCodeWidget } from "./EmbedCodeWidget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  return class EmbedCodeWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): EmbedCodeWidgetProps {
      const attrs = this.parseAttributes<EmbedCodeWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<EmbedCodeWidget {...this.props} />, container);
    }
...
const blockDefinition: BlockDefinition = {
    name: "embed-code-widget",
    factory: factory,
    attributes: ["code"],
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Embed Code Widget',
    iconUrl: "",
};
